...
```{r}
main_data <- read.csv("TMDB_tv_dataset_v3.csv")
main_data
```
```{r}
...
```{r}
#test_data_8a = apply_boxcox_transformation(data_8a_new, "number_of_seasons")
#test_data_8a
```

```{r}
plot(data_8a_new$duration, data_8a_new$number_of_seasons)
```
